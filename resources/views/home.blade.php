...
<head>
    ...
    <!--====== Favicon Icon ======-->
    <link rel="shortcut icon" href="consult-opl/assets/images/favicon.png" type="image/png">

    <!--====== Slick CSS ======-->
    <link rel="stylesheet" href="consult-opl/assets/css/slick.css">

    <!--====== Font Awesome CSS ======-->
    <link rel="stylesheet" href="consult-opl/assets/css/font-awesome.min.css">

    <!--====== Line Icons CSS ======-->
    <link rel="stylesheet" href="consult-opl/assets/css/LineIcons.css">

    <!--====== Animate CSS ======-->
    <link rel="stylesheet" href="consult-opl/assets/css/animate.css">

    <!--====== Magnific Popup CSS ======-->
    <link rel="stylesheet" href="consult-opl/assets/css/magnific-popup.css">

    <!--====== Bootstrap CSS ======-->
    <link rel="stylesheet" href="consult-opl/assets/css/bootstrap.min.css">

    <!--====== Default CSS ======-->
    <link rel="stylesheet" href="consult-opl/assets/css/default.css">

    <!--====== Style CSS ======-->
    <link rel="stylesheet" href="consult-opl/assets/css/style.css">
...
<body>
  ...
  <![endif]-->
    ...
    <header class="header-area">
                    ...
                    <div class="col-lg-12">
                        <nav class="navbar navbar-expand-lg">
                            <a class="navbar-brand" href="index.html">
                                <img src="consult-opl/assets/images/logo.png" alt="Logo">
                            </a>
        ...
        <div id="home" class="header-hero bg_cover d-lg-flex align-items-center" style="background-image: url(consult-opl/assets/images/header-hero.jpg)">
            <div class="container">
                <div class="row">
                    <div class="col-lg-7">
            ...
            <div class="header-hero-image d-flex align-items-center wow fadeInRightBig" data-wow-duration="1s" data-wow-delay="1.1s">
                <div class="image">
                    <img src="consult-opl/assets/images/hero-image.png" alt="Hero Image">
                </div>
            ...
            <div class="row">
                <div class="col-lg-12">
                    <div class="about-image mt-60 wow fadeIn" data-wow-duration="1s" data-wow-delay="0.5s">
                        <img src="consult-opl/assets/images/about.png" alt="about">
                    </div> <!-- about image -->
                </div>
            </div> <!-- row -->
            <div class="row justify-content-center">
                                ...
                                <div class="row">
                                    <div class="col-lg-6">
                                        <div class="our-services-image mt-50">
                                            <img src="consult-opl/assets/images/our-service-1.jpg" alt="service">
                    ...
                    <div class="col-lg-4 col-md-7">
                        <div class="single-service d-flex">
                            <div class="service-icon">
                                <img src="consult-opl/assets/images/service-1.png" alt="Icon">
                            </div>
                            ...
                            <div class="shape shape-1">
                                <img src="consult-opl/assets/images/shape/shape-1.svg" alt="shape">
                            </div>
                            <div class="shape shape-2">
                                <img src="consult-opl/assets/images/shape/shape-2.svg" alt="shape">
                            </div>
                        </div> <!-- single service -->
                    </div>
                    <div class="col-lg-4 col-md-7">
                        <div class="single-service service-border d-flex">
                            <div class="service-icon">
                                <img src="consult-opl/assets/images/service-2.png" alt="Icon">
                            </div>
                            <div class="service-content media-body">
                            ...
                            <div class="shape shape-3">
                                <img src="consult-opl/assets/images/shape/shape-3.svg" alt="shape">
                            </div>
                        </div> <!-- single service -->
                    </div>
                    <div class="col-lg-4 col-md-7">
                        <div class="single-service d-flex">
                            <div class="service-icon">
                                <img src="consult-opl/assets/images/service-3.png" alt="Icon">
                            </div>
                            <div class="service-content media-body">
                            ...
                            <div class="shape shape-4">
                                <img src="consult-opl/assets/images/shape/shape-4.svg" alt="shape">
                            </div>
                            <div class="shape shape-5">
                                <img src="consult-opl/assets/images/shape/shape-5.svg" alt="shape">
                            </div>
                        </div> <!-- single service -->
                    </div>
                </div> <!-- row -->
        ...
        <div class="container">
            ...
            <div class="row grid">
                <div class="col-lg-4 col-sm-6 grid-item apps creative laptop">
                    <div class="single-gallery gallery-masonry mt-30">
                        <div class="gallery-image">
                            <img src="consult-opl/assets/images/protfolio-1.jpg" alt="protfolio">
                        </div>
                        <div class="gallery-icon">
                            <a class="image-popup" href="consult-opl/assets/images/protfolio-1.jpg">
                                <span></span>
                            </a>
                        </div>
                    </div> <!-- single gallery -->
                ...
                <div class="col-lg-4 col-sm-6 grid-item branding creative">
                    <div class="single-gallery gallery-masonry mt-30">
                        <div class="gallery-image">
                            <img src="consult-opl/assets/images/protfolio-2.jpg" alt="protfolio">
                        </div>
                        <div class="gallery-icon">
                            <a class="image-popup" href="consult-opl/assets/images/protfolio-2.jpg">
                                <span></span>
                            </a>
                        </div>
                    </div> <!-- single gallery -->
                ...
                <div class="col-lg-4 col-sm-6 grid-item apps branding product">
                    <div class="single-gallery gallery-masonry mt-30">
                        <div class="gallery-image">
                            <img src="consult-opl/assets/images/protfolio-3.jpg" alt="protfolio">
                        </div>
                        <div class="gallery-icon">
                            <a class="image-popup" href="consult-opl/assets/images/protfolio-3.jpg">
                                <span></span>
                            </a>
                        </div>
                    </div> <!-- single gallery -->
                ...
                <div class="col-lg-4 col-sm-6 grid-item laptop product">
                    <div class="single-gallery gallery-masonry mt-30">
                        <div class="gallery-image">
                            <img src="consult-opl/assets/images/protfolio-5.jpg" alt="protfolio">
                        </div>
                        <div class="gallery-icon">
                            <a class="image-popup" href="consult-opl/assets/images/protfolio-5.jpg">
                                <span></span>
                            </a>
                        </div>
                    </div> <!-- single gallery -->
                ...
                <div class="col-lg-4 col-sm-6 grid-item branding creative">
                    <div class="single-gallery gallery-masonry mt-30">
                        <div class="gallery-image">
                            <img src="consult-opl/assets/images/protfolio-4.jpg" alt="protfolio">
                        </div>
                        <div class="gallery-icon">
                            <a class="image-popup" href="consult-opl/assets/images/protfolio-4.jpg">
                                <span></span>
                            </a>
                        </div>
                    </div> <!-- single gallery -->
                ...
                <div class="col-lg-4 col-sm-6 grid-item apps laptop product">
                    <div class="single-gallery gallery-masonry mt-30">
                        <div class="gallery-image">
                            <img src="consult-opl/assets/images/protfolio-6.jpg" alt="protfolio">
                        </div>
                        <div class="gallery-icon">
                            <a class="image-popup" href="consult-opl/assets/images/protfolio-6.jpg">
                                <span></span>
                            </a>
                        </div>
                    </div> <!-- single gallery -->
                        ...
                        <div class="testimonial-content-wrapper testimonial-active">
                                ...
                                <div class="testimonial-author d-sm-flex justify-content-between">
                                    <div class="author-info d-flex align-items-center">
                                        <div class="author-image">
                                            <img src="consult-opl/assets/images/author-1.jpg" alt="author">
                                        </div>
                            ...
                            <div class="single-testimonial">
                                ...
                                <div class="testimonial-author d-sm-flex justify-content-between">
                                    <div class="author-info d-flex align-items-center">
                                        <div class="author-image">
                                            <img src="consult-opl/assets/images/author-2.jpg" alt="author">
                                        </div>
                                        <div class="author-name media-body">
                                            <h5 class="name">John Doe</h5>
                                            <span class="sub-title">CEO, Alphabet</span>
                            ...
                            <div class="single-testimonial">
                                ...
                                <div class="testimonial-author d-sm-flex justify-content-between">
                                    <div class="author-info d-flex align-items-center">
                                        <div class="author-image">
                                            <img src="consult-opl/assets/images/author-3.jpg" alt="author">
                                        </div>
                                        <div class="author-name media-body">
                                            <h5 class="name">John Doe</h5>
                                            <span class="sub-title">CEO, Alphabet</span>
            ...
            <div class="row justify-content-center">
                <div class="col-lg-4 col-md-6 col-sm-8">
                    <div class="single-blog mt-30 wow fadeInUpBig" data-wow-duration="1s" data-wow-delay="0.4s">
                        <div class="blog-image">
                            <a href="blog-details.html"><img src="consult-opl/assets/images/news-1.jpg" alt="news"></a>
                        </div>
                ...
                <div class="col-lg-4 col-md-6 col-sm-8">
                    <div class="single-blog mt-30 wow fadeInUpBig" data-wow-duration="1s" data-wow-delay="0.7s">
                        <div class="blog-image">
                            <a href="blog-details.html"><img src="consult-opl/assets/images/news-2.jpg" alt="news"></a>
                        </div>
                        <div class="blog-content">
                            <h4 class="blog-title"><a href="blog-details.html">Nulla eget urna at tortor turpi feugiat tristique in sit.</a></h4>
                            <div class="blog-author d-flex align-items-center">
                ...
                <div class="col-lg-4 col-md-6 col-sm-8">
                    <div class="single-blog mt-30 wow fadeInUpBig" data-wow-duration="1s" data-wow-delay="1s">
                        <div class="blog-image">
                            <a href="blog-details.html"><img src="consult-opl/assets/images/news-3.jpg" alt="news"></a>
                        </div>
                        <div class="blog-content">
                            <h4 class="blog-title"><a href="blog-details.html">Nulla eget urna at tortor turpi feugiat tristique in sit.</a></h4>
                            <div class="blog-author d-flex align-items-center">
            ...
            <div class="row">
                <div class="col-lg-12">
                    <div class="contact-wrapper-form pt-115  wow fadeInUpBig" data-wow-duration="1s" data-wow-delay="0.5s">
                        ...
                        <form id="contact-form" action="consult-opl/assets/contact.php" method="post">
                            <div class="row">
                                <div class="col-md-6">
    ...
    <footer id="footer" class="footer-area bg_cover" style="background-image: url(consult-opl/assets/images/footer-bg.jpg)">
        <div class="container">
    ...
    <!--====== Jquery js ======-->
    <script src="consult-opl/assets/js/vendor/jquery-1.12.4.min.js"></script>
    <script src="consult-opl/assets/js/vendor/modernizr-3.7.1.min.js"></script>

    <!--====== Bootstrap js ======-->
    <script src="consult-opl/assets/js/popper.min.js"></script>
    <script src="consult-opl/assets/js/bootstrap.min.js"></script>

    <!--====== Slick js ======-->
    <script src="consult-opl/assets/js/slick.min.js"></script>

    <!--====== Isotope js ======-->
    <script src="consult-opl/assets/js/imagesloaded.pkgd.min.js"></script>
    <script src="consult-opl/assets/js/isotope.pkgd.min.js"></script>

    <!--====== Counter Up js ======-->
    <script src="consult-opl/assets/js/waypoints.min.js"></script>
    <script src="consult-opl/assets/js/jquery.counterup.min.js"></script>

    <!--====== Circles js ======-->
    <script src="consult-opl/assets/js/circles.min.js"></script>

    <!--====== Appear js ======-->
    <script src="consult-opl/assets/js/jquery.appear.min.js"></script>

    <!--====== WOW js ======-->
    <script src="consult-opl/assets/js/wow.min.js"></script>

    <!--====== Headroom js ======-->
    <script src="consult-opl/assets/js/headroom.min.js"></script>

    <!--====== Jquery Nav js ======-->
    <script src="consult-opl/assets/js/jquery.nav.js"></script>

    <!--====== Scroll It js ======-->
    <script src="consult-opl/assets/js/scrollIt.min.js"></script>

    <!--====== Magnific Popup js ======-->
    <script src="consult-opl/assets/js/jquery.magnific-popup.min.js"></script>

    <!--====== Main js ======-->
    <script src="consult-opl/assets/js/main.js"></script>
